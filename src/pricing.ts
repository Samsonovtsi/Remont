...
export const PACKAGE_PRICES: Record<PackageCode, PackagePrice> = {
  minimal: {
    ...
    minPerM2: 20_500,
    maxPerM2: 20_500,
    description: 'Базовый ремонт для быстрой сдачи или продажи — функционально и недорого.',
    calculationMode: 'fixed',
    included: ['Работа', 'Чистовые материалы', 'Черновые материалы', 'Доставка', 'Вынос мусора'],
    gifts: ['Комплектовка', 'Технические чертежи', 'Страховка ремонта', 'Клининг', 'Фотографирование объекта'],
    benefits: ['Фиксируем стоимость и сроки', 'Гарантия 12 месяцев', 'Рассрочка до 6 месяцев']
  },
  standard: {
    title: 'Стандарт',
    minPerM2: 22_700,
    maxPerM2: 37_600,
    description: 'Современный дизайн и качественные материалы — решение для среднего ценового сегмента.',
  ...
  comfort: {
    ...
    minPerM2: 32_200,
    maxPerM2: 47_300,
    description: 'Улучшенная комплектация, стиль и комфорт — повышает привлекательность объекта.',
    calculationMode: 'smeta',
    included: ['Работа', 'Чистовые материалы', 'Черновые материалы', 'Доставка', 'Вынос мусора'],
    gifts: ['Комплектовка', 'Технические чертежи', 'Страховка ремонта', 'Клининг', 'Фотографирование объекта'],
    benefits: ['Фиксируем стоимость и сроки', 'Гарантия 12 месяцев', 'Рассрочка до 6 месяцев']
  ...
  premium: {
    ...
    minPerM2: 42_800,
    maxPerM2: 42_800,
    description: 'Авторский дизайн, индивидуальная планировка и материалы премиум-класса.',
    calculationMode: 'fixed',
    included: ['Работа', 'Чистовые материалы', 'Черновые материалы', 'Доставка', 'Вынос мусора'],
    gifts: ['Комплектовка', 'Технические чертежи', 'Страховка ремонта', 'Клининг', 'Фотографирование объекта'],
    benefits: ['Фиксируем стоимость и сроки', 'Гарантия 12 месяцев', 'Рассрочка до 6 месяцев']
